...
const Register = () => {
  ...
  const validateField = (name, value) => {
    ...
    if (name === "username") {
      if (!value) errorMsg = "Username wajib diisi.";
      else if (value.length < 2) errorMsg = "Minimal 2 karakter.";
    }
  ...
  const handleChange = (e) => {
    ...
    validateField(name, value); // ✅ langsung validasi
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors((prev) => ({
        ...prev,
        global: err?.message || "Registrasi gagal, coba lagi.",
      }));
    }
  };
